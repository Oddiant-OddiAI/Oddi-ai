...
# HR interview alias: both phrasings use the same full fast response.
JOB_FAST_RESPONSES["help me prepare for hr interview"] = JOB_FAST_RESPONSES["help me in preparation for hr interview"]